...
> 每项可能 FAIL 的检查的可操作修复命令。
> 仅信息级检查（A9、A10、A12、C3、D7）不在此列，因为它们仅为建议性质。
> 将 `{placeholder}` 值替换为实际资源名称。
...
**成本影响:** Zero — pure K8s resource conversion (Pod to Deployment)
#### 修复方法
...
**成本影响:** +1 Pod per workload — doubles CPU/memory; may trigger additional node
#### 修复方法
...
**成本影响:** Zero — K8s scheduling configuration only
#### 修复方法
...
**成本影响:** Zero — K8s probe configuration only
#### 修复方法
...
**成本影响:** Zero — K8s PDB configuration only
#### 修复方法
...
**成本影响:** ~0.5 vCPU + 256MB memory for metrics-server Pod
#### 修复方法
...
**成本影响:** HPA free; autoscaled Pods may increase compute cost
#### 修复方法
...
**成本影响:** Zero — K8s lifecycle configuration only
#### 修复方法
...
**成本影响:** CloudWatch Container Insights: per-metric + log volume pricing; Prometheus: ~2 vCPU + 8GB
#### 修复方法
...
**成本影响:** Fluent Bit DaemonSet: ~0.5 vCPU + 256MB per node; CW Logs ~\$0.50/GB ingested
#### 修复方法
...
**成本影响:** CloudWatch Logs: ~\$0.50/GB ingested (control plane ~1-5 GB/month)
#### 修复方法
...
**成本影响:** Zero — authentication configuration only
#### 修复方法
...
**成本影响:** Zero — endpoint access configuration only
#### 修复方法
...
**成本影响:** Zero — webhook scope configuration only
#### 修复方法
...
**成本影响:** Karpenter free; CA: ~0.5 vCPU; auto-scaling increases EC2 spend
#### 修复方法
...
**成本影响:** May require additional nodes in underrepresented AZs
#### 修复方法
...
**成本影响:** Zero — may expose need for more capacity if requests were previously unset
#### 修复方法
...
**成本影响:** Zero — K8s quota configuration only
#### 修复方法
...
**成本影响:** Zero — K8s LimitRange configuration only
#### 修复方法
...
**成本影响:** Zero — metrics endpoint configuration only
#### 修复方法
